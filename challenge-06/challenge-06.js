...
desafio.
*/
var teams = ['Fluminense', 'Vasco', 'Flamengo', 'Palmeiras', 'Atletico'];
...
function showTeamPosition(num) {
    ...
    return 'O time que está em ' + num + 'º lugar é o ' + teams[teamIndex] + '.';
}
...
*/
console.log(showTeamPosition(1)); //O time que está em 1º lugar é o Fluminense.
console.log(showTeamPosition(2)); //O time que está em 2º lugar é o Vasco.
